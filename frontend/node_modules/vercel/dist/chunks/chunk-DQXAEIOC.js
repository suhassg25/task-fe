...
var require_utils = __commonJS({
  "../../node_modules/.pnpm/cli-table3@0.6.3/node_modules/cli-table3/src/utils.js"(exports, module) {
    ...
    function wordWrap2(maxLength, input) {
      let lines = [];
    ...
    function multiLineWordWrap(maxLength, input, wrapOnWordBoundary = true) {
      let output = [];
      input = input.split("\n");
      const handler = wrapOnWordBoundary ? wordWrap2 : textWrap;
...
var require_cell = __commonJS({
  "../../node_modules/.pnpm/cli-table3@0.6.3/node_modules/cli-table3/src/cell.js"(exports, module) {
    ...
    var Cell = class _Cell {
      ...
      mergeTableOptions(tableOptions2, cells) {
        this.cells = cells;
        let optionsChars = this.options.chars || {};
        let tableChars = tableOptions2.chars;
        let chars = this.chars = {};
        CHAR_NAMES.forEach(function(name) {
          setOption(optionsChars, tableChars, name, chars);
        });
        this.truncate = this.options.truncate || tableOptions2.truncate;
        let style = this.options.style = this.options.style || {};
        let tableStyle = tableOptions2.style;
        setOption(style, tableStyle, "padding-left", this);
        setOption(style, tableStyle, "padding-right", this);
        this.head = style.head || tableStyle.head;
        this.border = style.border || tableStyle.border;
        this.fixedWidth = tableOptions2.colWidths[this.x];
        this.lines = this.computeLines(tableOptions2);
        this.desiredWidth = utils.strlen(this.content) + this.paddingLeft + this.paddingRight;
        this.desiredHeight = this.lines.length;
      }
      computeLines(tableOptions2) {
        const tableWordWrap = tableOptions2.wordWrap || tableOptions2.textWrap;
        ...
        if (this.fixedWidth && wordWrap2) {
          ...
          if (this.colSpan) {
            ...
            while (i < this.colSpan) {
              this.fixedWidth += tableOptions2.colWidths[this.x + i];
              i++;
            }
          }
          const { wrapOnWordBoundary: tableWrapOnWordBoundary = true } = tableOptions2;
      ...
      init(tableOptions2) {
        let x = this.x;
        let y = this.y;
        this.widths = tableOptions2.colWidths.slice(x, x + this.colSpan);
        this.heights = tableOptions2.rowHeights.slice(y, y + this.rowSpan);
        this.width = this.widths.reduce(sumPlusOne, -1);
        this.height = this.heights.reduce(sumPlusOne, -1);
        this.hAlign = this.options.hAlign || tableOptions2.colAligns[x];
        this.vAlign = this.options.vAlign || tableOptions2.rowAligns[y];
        this.drawRight = x + this.colSpan == tableOptions2.colWidths.length;
      }
      /**
    ...
    var RowSpanCell = class {
      ...
      init(tableOptions2) {
        ...
        this.offset = findDimension(tableOptions2.rowHeights, originalY, this.cellOffset);
      }
      draw(lineNum) {
        if (lineNum == "top") {
